            ...
            <div className="mb-3">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-7 pr-3 py-1.5 text-xs text-gray-900 placeholder:text-gray-500 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
